...
- .انشاء حساب سورس العرب الاسلامي  
...
- مثال: .انشاء حساب الرافدين او سورس العرب الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "سورس العرب الاسلامي":
        bankn = "مصرف سورس العرب الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "سورس العرب الاسلامي":
